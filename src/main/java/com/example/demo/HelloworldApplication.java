...
//		logger.debug(controller.toString());
		EmployeeBean beanEmployeeBean= context.getBean(EmployeeBean.class);
		logger.debug(beanEmployeeBean.toString());
		beanEmployeeBean.setEid(104);
		logger.debug(beanEmployeeBean.toString());
		beanEmployeeBean.setEname("Spring Framework Guru");
		logger.debug(beanEmployeeBean.toString());
		beanEmployeeBean.showEmployeeDetails();
